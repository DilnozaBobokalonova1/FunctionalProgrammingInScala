...
object rationals {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(60); 
	...
	x + y;System.out.println("""res4: week3.Rational = """ + $show(res$4));$skip(17); val res$5 = 
	x.sub(y).sub(z);System.out.println("""res5: week3.Rational = """ + $show(res$5));$skip(7); val res$6 = 
	y + y;System.out.println("""res6: week3.Rational = """ + $show(res$6));$skip(11); val res$7 = 
	x.less(y);System.out.println("""res7: Boolean = """ + $show(res$7));$skip(10); val res$8 = 
	x.max(y);System.out.println("""res8: week3.Rational = """ + $show(res$8));$skip(77); val res$9 = 
	//val strange = new Rational(1, 0)
	//strange.add(strange)
	new Rational(2);System.out.println("""res9: week3.Rational = """ + $show(res$9))}
}
